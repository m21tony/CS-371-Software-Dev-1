...
public int overallScore()
{
   ...
   if (score1 < score2 && score1 < score3) {
      ...
      s1 = score1;
      s2 = score3; //corrected s2 = score2 to s2 = score3
   } else if (score3 < score1 && score3 < score2) {
      s1 = score1;
      s2 = score2;
   }
   
   // if 2 values are the and one is different, score isn't calculated correctly
   // so I added new if - else statements to handle this error
...
{
   int s1, s2, s3;
   if (args.length != 3) { // removed "args == null" because testing null is not possible
